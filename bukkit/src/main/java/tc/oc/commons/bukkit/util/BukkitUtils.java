...
public class BukkitUtils {
    ...
    public static DyeColor chatColorToDyeColor(ChatColor chatColor) {
        DyeColor dyeColor = DYE_CHAT_MAP.inverse().get(chatColor);
        if (dyeColor != null) {
            return dyeColor;
        } else {
    ...
    private static final BiMap<DyeColor, ChatColor> DYE_CHAT_MAP = ImmutableBiMap.<DyeColor, ChatColor>builder()
